    ...
    <div class="policy-page">
        <div class="container narrow">
            ...
            <section class="policy-section">
                ...
                <div class="alert-box">
                    <p><strong>{{ t('policies.refund.note_title') }}</strong> {{ t('policies.refund.note_desc') }}</p>                </div>
            </section>
            ...
            <section class="policy-section">
                ...
                <ol>
                    ...
                    <li>{{ t('policies.refund.step3') }}</li>                </ol>
            </section>

            <section class="policy-section">
                <h2>{{ t('policies.refund.process_title') }}</h2>
                <p>{{ t('policies.refund.process_desc') }}</p>            </section>
        </div>
    </div>
  `,
    styles: [`
